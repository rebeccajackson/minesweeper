...
function isInvalidCell (cell) {
  ...
  if (!cell.hasOwnProperty('row')) {
    displayMessage('<p>I found a cell without a <code>row</code> property! An example of an object that passes this test is:</p><pre><code>{ row: 0 }</code></pre>')
    return true
  }
  if (!cell.hasOwnProperty('col')) {
    displayMessage('<p>I found a cell without a <code>col</code> property! An example of an object that passes this test is:</p><pre><code>{ col: 0 }</code></pre>')
    return true
  }
